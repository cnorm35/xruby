...
class CustomSetTest < Minitest::Test
  def test_sets_with_no_elements_are_empty
    # skip
    set = CustomSet.new []
    assert_equal set, CustomSet.new
  end

  def test_sets_with_elements_are_not_empty
    skip
    set = CustomSet.new [1]
    refute_equal set, CustomSet.new
  end
  ...
  def test_add_to_empty_set
    ...
    assert_equal set.put(element), expected
  end
  ...
  def test_intersection_of_two_empty_sets_is_an_empty_set
    ...
    assert_equal set2.intersection(set1), expected
  end
  ...
  def test_difference_of_two_empty_sets_is_an_empty_set
    ...
    set2 = CustomSet.new []
    expected = CustomSet.new([])
    assert_equal set1.difference(set2), expected
  end
  ...
  def test_union_of_empty_sets_is_an_empty_set
    ...
    set2 = CustomSet.new []
    expected = CustomSet.new([])
    assert_equal set1.union(set2), expected
  end
